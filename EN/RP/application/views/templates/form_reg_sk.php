...
?>
				<ul>
					...
					<span id="info">every field is required</span></li>
					<li><label for="username">Login:</label><?php echo form_input($log);?></li>
					<li><label for="password">Password:</label><?php echo form_password($pwd);?></li>
					<li><label for="cpassword">Condfirm password:</label><?php echo form_password($cpwd);?></li>
